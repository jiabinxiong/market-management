    ...
    return (
        <Fragment>
            ...
            <Dialog
                ...
                titleText="创建市场"
                className={`${props.marketOperateTypeReducer === MARKET_OPERATE_TYPE.NEW || MARKET_OPERATE_TYPE.UPDATE ? 'market-new-pop' : '' }`}
...
export default connect(
    data => ({
        ...
        marketUpdateChangeAction: marketAction.updateChange,
